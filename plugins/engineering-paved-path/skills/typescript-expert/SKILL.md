...
0. If the issue requires expertise this skill doesn't cover (e.g. deep
   webpack/vite/rollup bundler internals, complex ESM/CJS migration, or
   compiler-internals-level type performance profiling), say so plainly and
   apply the closest guidance below rather than guessing.
